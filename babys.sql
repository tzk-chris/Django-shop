...
CREATE TABLE `commodity_commodityinfos`  (
  ...
  `sezes` varchar(100) CHARACTER SET utf8  COLLATE utf8_general_ci NOT NULL,
  `types` varchar(100) CHARACTER SET utf8  COLLATE utf8_general_ci NOT NULL,
...
INSERT INTO `commodity_commodityinfos` VALUES (4, '婴儿防寒针织帽', '蓝色', '配饰', 50, 39, 2347, 4521, 902, '2020-02-24', 'imgs/p4.jpg', 'details/p4_details.jpg');
...
CREATE TABLE `commodity_types`  (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `firsts` varchar(100) CHARACTER SET utf8  COLLATE utf8_general_ci NOT NULL,
  `seconds` varchar(100) CHARACTER SET utf8  COLLATE utf8_general_ci NOT NULL,
  PRIMARY KEY (`id`) USING BTREE
